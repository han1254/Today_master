...
public class DetailCanDoAdapter extends BaseRecyclerViewAdapter<DetailModel.PreviewBean.GoodBean> {

    public DetailCanDoAdapter(List<DetailModel.PreviewBean.GoodBean> goodBeans, Context context, int itemLayoutId) {
        super(goodBeans, context, itemLayoutId);
    }

    @Override
    protected void bindView(BaseViewHolder viewHolder, DetailModel.PreviewBean.GoodBean item) {
        ...
        img.setBackgroundColor(mContext.getResources().getColor(R.color.green));
    }
}
